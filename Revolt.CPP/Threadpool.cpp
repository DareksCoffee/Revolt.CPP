...
RevoltCPP::Threadpool::Threadpool(const unsigned int size) {
...
RevoltCPP::Threadpool::~Threadpool() {
    {
...
void RevoltCPP::Threadpool::start_thread() {
    std::lock_guard<std::mutex> lock(state_mutex);
...
void RevoltCPP::Threadpool::queue_task(const std::function<void()>& task) {
